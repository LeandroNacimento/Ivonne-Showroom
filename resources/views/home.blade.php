                ...
                <div class="sm:text-center lg:text-left">
                    ...
                    <div class="reveal mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start" style="transition-delay: 200ms;">
                        ...
                        <div class="mt-3 sm:mt-0 sm:ml-3">
                            <a href="{{ route('contact') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-brand-pink bg-white hover:bg-gray-50 md:py-4 md:text-lg transition-colors">
                                Contactar
                            </a>
                        </div>
                    </div>
