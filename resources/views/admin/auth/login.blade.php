...
<body class="font-sans antialiased min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-pink-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl ring-1 ring-gray-900/5">
        <div class="flex flex-col items-center">
            <img class="h-24 w-auto hover:scale-105 transition-transform duration-300 ease-out" src="{{ asset('img/Logo.png') }}" alt="Ivonne Showroom">
            <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900 tracking-tight font-sans">Acceso Administrativo</h2>
            ...
            <div>
                <button type="submit" 
                    ...
                    <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                        <svg class="h-5 w-5 text-pink-300 group-hover:text-pink-200 transition-colors" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
