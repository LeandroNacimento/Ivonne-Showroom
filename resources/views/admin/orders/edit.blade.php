                        ...
                        <div class="bg-white rounded-lg shadow-sm p-6">
                                ...
                                <select name="client_id" id="client_id"
                                    ...
                                    @foreach ($clients as $client)
                                        <option value="{{ $client->id }}"
                                            {{ $order->client_id == $client->id ? 'selected' : '' }}>{{ $client->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status" id="status"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand-pink focus:ring focus:ring-brand-pink focus:ring-opacity-50"
                                    required>
                                    <option value="draft" {{ $order->status == 'draft' ? 'selected' : '' }}>Borrador
                                    </option>
                                    <option value="reserved" {{ $order->status == 'reserved' ? 'selected' : '' }}>Reservado
                                    </option>
