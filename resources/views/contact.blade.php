            ...
            <div class="bg-brand-blush rounded-lg p-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        <svg class="h-6 w-6 text-brand-pink mt-1 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                            ...
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings['whatsapp_number'] ?? '5493704550445') }}" class="text-brand-pink hover:underline text-sm">Enviar mensaje</a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">{{ $settings['address'] ?? 'Napoleón Uriburu 1366, Formosa Capital' }}</p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">{{ $settings['hours'] ?? 'Lunes a Sábado: 9:00 - 12:30 / 17:00 - 21:00' }}</p>
                        </div>
                    </div>
                </div>
            </div>
