...
<div class="bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <div class="flex gap-4 mt-4 md:mt-0">
                <form action="{{ route('catalog') }}" method="GET" class="flex gap-2">
                    <select name="category" class="rounded-md border-gray-300 shadow-sm focus:border-brand-pink focus:ring focus:ring-brand-pink focus:ring-opacity-50" onchange="this.form.submit()">
                    ...
                    <select name="sort" class="rounded-md border-gray-300 shadow-sm focus:border-brand-pink focus:ring focus:ring-brand-pink focus:ring-opacity-50" onchange="this.form.submit()">
        ...
        <div class="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
            ...
            <div class="group relative bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <div class="col-span-full text-center py-12">
                ...
                <a href="{{ route('catalog') }}" class="text-brand-pink hover:underline mt-2 inline-block">Limpiar filtros</a>
            </div>
            @endforelse
        </div>
