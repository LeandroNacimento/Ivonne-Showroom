<div
    x-data="{ expanded: false, canHover: window.matchMedia('(hover: hover)').matches }"
    @mouseenter="if (canHover) expanded = true"
    @mouseleave="if (canHover) expanded = false"
    ...
    @if ($itemCount > 0)
        ...
        <div x-show="expanded"
            ...
            <h4 class="text-sm font-semibold text-text-dark mb-2 border-b pb-2">
                Resumen
            </h4>
