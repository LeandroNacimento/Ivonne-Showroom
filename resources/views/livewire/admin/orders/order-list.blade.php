    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
        ...
        <div class="border-b border-gray-200 px-4 py-5 sm:px-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <!-- Status Select -->
                <div>
                     <select wire:model.live="status" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-brand-pink sm:text-sm sm:leading-6">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="date" wire:model.live="date_from" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-brand-pink sm:text-sm sm:leading-6">
                </div>

                <!-- Date To -->
                <div class="flex items-center gap-2">
                    <span class="text-sm text-gray-500 w-12">Hasta:</span>
                    <input type="date" wire:model.live="date_to" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-brand-pink sm:text-sm sm:leading-6">
                </div>
            </div>
        </div>
