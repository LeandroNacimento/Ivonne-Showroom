                ...
                <div class="mt-6">
                    <template x-if="activeVariations.length > 0">
                        <form x-data="{ qty: 1 }" @submit.prevent="$wire.addToCart(selectedVariation, qty)">
                            ...
                            @else
                                <!-- Auto-select single variation for products without sizes -->
                            ...
                            <div class="flex flex-col items-start mt-6 mb-6"
                                x-effect="if (selectedStock !== null && qty > selectedStock) qty = Math.max(1, selectedStock)">
                                <label for="quantity" class="text-sm font-medium text-gray-700 mb-2">Cantidad:</label>
                                <div class="flex items-center border border-gray-300 gap-3 rounded-lg px-3 py-2 w-fit">
